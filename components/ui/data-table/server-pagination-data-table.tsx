...
interface ServerPaginationDataTableProps<TData, TValue> {
...
export function ServerPaginationDataTable<TData, TValue>({
  columns,
  data,
  meta,
  searchKey,
...
}: ServerPaginationDataTableProps<TData, TValue>) {
