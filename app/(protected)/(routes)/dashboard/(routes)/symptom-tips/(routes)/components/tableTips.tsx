...
// FIX: Rename interface from VarietyDataTableProps
interface SymptomReliefTipDataTableProps<TData, TValue> {
...
// FIX: Rename component from VarietyDataTable
export function SymptomReliefTipDataTable<TData, TValue>({
  columns,
  data,
  meta,
  searchKey,
...
}: SymptomReliefTipDataTableProps<TData, TValue>) {
