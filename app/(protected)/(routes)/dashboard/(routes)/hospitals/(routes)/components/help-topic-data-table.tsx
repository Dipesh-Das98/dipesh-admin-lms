// components/ui/data-table/server-side-data-table.tsx (or similar file)
"use client";
...
// FIX 1: Rename the interface to reflect generic table properties
...
// FIX 2: Rename the exported function to a more generic name
