...
type BasicSettingsFormData = z.infer<typeof updateLibrarySchema>;
...
export function BasicSettingsForm({
  ...
  const form = useForm<BasicSettingsFormData>({
    ...
    defaultValues: {
      ...
      backgroundColor: library.backgroundColor || "#3b82f6",
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Update the core information for this library
            </p>
          </div>
        </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  ...
                  <FormControl>
                    <Input
                      placeholder="Enter the library title"
                      {...field}
                  ...
                  <FormItemInfo message="📚 A catchy title that captures the essence of your library" />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Provide a brief description of the library"
                      {...field}
                      rows={4}
                  ...
                  <FormMessage className="text-xs" />
                  <FormItemInfo message="📝 A compelling description that helps users understand what the library is about (max 500 characters)" />
                </FormItem>
              )}
            />
                    ...
                    >
                      <FormControl>
                        <SelectTrigger className="h-12 border-border/50 bg-background/50 focus:bg-background transition-colors duration-200 focus:ring-2 focus:ring-primary/20">
                          <SelectValue placeholder="Select the library language" />
                        </SelectTrigger>
                      </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    ...
                    <FormMessage className="text-xs" />
                    <FormItemInfo message="🔢 Lower numbers appear first in the library list" />
                  </FormItem>
                )}
              />
            </div>
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  ...
                  >
                    <FormControl>
                      <SelectTrigger className="h-12 border-border/50 bg-background/50 focus:bg-background transition-colors duration-200 focus:ring-2 focus:ring-primary/20">
                        <SelectValue placeholder="Choose a category for the library" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent className="border-border/50">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  ...
                  <FormMessage className="text-xs" />
                  <FormItemInfo message="🎨 The background color helps create visual distinction and mood for the library" />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {field.value 
                          ? "✅ This library is active and visible to users" 
                          : "⏸️ This library is inactive and hidden from users"
                        }
                      </p>
                    </div>
                    <FormControl>
                  ...
                  <FormMessage className="text-xs" />
                  <FormItemInfo message="🔄 Toggle to control whether this library appears in the public library list" />
                </FormItem>
              )}
            />
