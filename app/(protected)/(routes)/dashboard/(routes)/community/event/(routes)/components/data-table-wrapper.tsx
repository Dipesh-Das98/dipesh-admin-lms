...
import { getEvents } from "@/actions/dashboard/community/event";
...
const DataTableWrapper = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["events", page, perPage, search, sortBy, sortOrder],
    queryFn: () => getEvents(page, perPage, search, sortBy, sortOrder),
