...
import { getAdmins } from "@/actions/dashboard/admin/get-admins";
...
const DataTableWrapper = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["admins", page, perPage, search, sortBy, sortOrder],
    queryFn: () => getAdmins(page, perPage, search, sortBy, sortOrder),
