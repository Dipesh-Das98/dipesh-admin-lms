      ...
      <div className="flex gap-4 items-center justify-between py-4">
        <div className="flex items-center gap-4">
          ...
          <Popover
            ...
            onOpenChange={setActivityFilterOpen}
          >
                  ...
                  <div className="space-y-1">
                    {CATEGORY_TYPES.map((type) => (
                      <button
                        key={type}
                        className={cn(
                          "w-full flex items-center justify-between rounded-sm px-2 py-1.5 text-sm hover:bg-accent hover:text-accent-foreground capitalize",
                          currentType === type && "bg-accent"
                        )}
                        onClick={() => handleActivityFilter(type)}
                      >
        ...
        <Button onClick={handleOpenSheet}>create category</Button>
      </div>
