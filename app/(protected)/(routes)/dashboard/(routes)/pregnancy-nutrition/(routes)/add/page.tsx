...
const AddPregnancyNutritionTipPage = () => { // FIX: Rename component
  return (
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">
              {/* FIX: Update title */}
              Add Pregnancy Nutrition Tip
            </h1>
            <p className="text-muted-foreground mt-1">
              {/* FIX: Update description */}
              Provide food details, associated weeks, health benefits, and nutrition facts.
            </p>
          </div>
        </div>
      </div>
...
export default AddPregnancyNutritionTipPage; // FIX: Rename the exported component