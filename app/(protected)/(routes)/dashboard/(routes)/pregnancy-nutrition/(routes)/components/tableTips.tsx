...
// FIX 1: Rename interface to PregnancyNutritionTipDataTableProps
interface PregnancyNutritionTipDataTableProps<TData, TValue> {
...
// FIX 2: Rename component to PregnancyNutritionTipDataTable
export function PregnancyNutritionTipDataTable<TData, TValue>({
  columns,
  data,
  meta,
  searchKey,
...
}: PregnancyNutritionTipDataTableProps<TData, TValue>) {
