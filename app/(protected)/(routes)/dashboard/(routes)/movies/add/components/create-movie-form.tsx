...
import { createMovie } from "@/actions/dashboard/movie/create-movie";
...
export function CreateMovieForm() {
  ...
  >({
    ...
    queryFn: () => getCategoryByType("movie"),
  });
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (result) => {
      if (result.success) {
        ...
        setTimeout(() => {
          router.push(`/dashboard/movies/edit/${result.data?.id}`);
        }, 1000); // Delay to allow toast to show
      } else {
        toast.error(result.message || "Failed to create movie");
        console.error("Create movie failed:", result);
      }
    },
    onError: (error) => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Create a basic movie that you can enhance with media and
                  content later
                </CardDescription>
              </div>
            </div>
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide the basic information about your movie
              </CardDescription>
            </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Provide a brief description of the movie (max 500
                      characters)
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                ...
                add media content and finalize your movie.
              </div>
            </CardContent>
          </Card>
        </form>
