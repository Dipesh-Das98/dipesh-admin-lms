...
interface MovieDataTableProps<TData, TValue> {
...
export function MovieDataTable<TData, TValue>({
  columns,
  data,
  meta,
  searchKey,
...
}: MovieDataTableProps<TData, TValue>) {
  ...
  return (
    <ServerPaginationDataTable
      ...
      actions={
        <Button onClick={handleAddMovie} className="flex items-center gap-2" size="sm">
