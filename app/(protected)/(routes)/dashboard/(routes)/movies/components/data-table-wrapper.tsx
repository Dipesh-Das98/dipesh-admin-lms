...
import { getMovies } from "@/actions/dashboard/movie/get-movies";
...
const DataTableWrapper = () => {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["movies", page, perPage, search, sortBy, sortOrder],
    queryFn: () => getMovies(page, perPage, search, sortBy, sortOrder),
    ...
    return (
      <div className="flex items-center justify-center p-8">
        <div className="text-center">
          <h3 className="text-lg font-semibold text-red-600">Error Loading Movies</h3>
